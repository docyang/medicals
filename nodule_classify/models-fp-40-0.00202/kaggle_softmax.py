...
Wb = {
    ...
    'fcw1': tf.get_variable('fcw1', [4**3 * 32, 16], tf.float32, XAVIER_INIT),
...
def lunaTrain(train_size, test_size):
  ...
  fqbt, rbt = init_bin_file([("./data/kong_data/train%d" % i) for i in range(7)])
  ...
  learning_rate = tf.train.exponential_decay(0.01, global_step, 2000, 0.5, staircase=True)
...
def main(_):
  train_size = 650814 #{7994:536, 17012:738, 4514:478, 14610:538， 5510：561, 9291:586}
  test_size = 2000
